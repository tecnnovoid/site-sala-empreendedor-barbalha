  ...
  return (
    <section id="home" className="pt-32 flex flex-col items-center lg:flex lg:flex-row lg:pt-40">
      ...
      <div className="mt-8 md:flex md:flex-row md:gap-8">
        <img src="/assets/images/img-sala1.png" alt="Foto Sala do Empreendedor de Barbalha" className="2xl:h-[60vh]" />
        <img src="/assets/images/img-sala2.png" alt="Foto Sala do Empreendedor de Barbalha" className="hidden md:flex 2xl:h-[60vh]" />
      </div>
    </section>
  );
}
